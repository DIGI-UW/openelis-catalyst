# OpenELIS Spark reference source

**Status:** Not implemented.

This directory owns the OpenELIS source assets used by the selected reference
deployment:

```text
retained OpenELIS demo data
...
The current runtime uses the PostgreSQL sink, SQL, catalog, and health files in
